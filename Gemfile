...
gem "actionpack", ">= 5.0.0.rc1", "< 5.1"
gem "actionview", ">= 5.0.0.rc1", "< 5.1"
gem "activejob", ">= 5.0.0.rc1", "< 5.1"
gem "activemodel", ">= 5.0.0.rc1", "< 5.1"
gem "activerecord", ">= 5.0.0.rc1", "< 5.1"
gem "activesupport", ">= 5.0.0.rc1", "< 5.1"
gem "addressable"
